...
class STM_LMS_Quiz {
	...
	public static function user_answers() {
		...
		if ( 'passed' === $status ) {
			...
			STM_LMS_Helpers::send_email( $user['email'], 'Quiz Completed', $message, 'stm_lms_course_quiz_completed_for_user', compact( 'user_login', 'course_title', 'quiz_name', 'passing_grade' ) );
		}
